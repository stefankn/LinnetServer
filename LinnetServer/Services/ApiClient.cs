...
public class ApiClient
{
    ...
    {
        var url = $"/player_api.php?username={Uri.EscapeDataString(_options.Username)}&password={Uri.EscapeDataString(_options.Password)}&action=get_series_categories";
        var response = await _httpClient.GetAsync(url);
        response.EnsureSuccessStatusCode();
    ...
    {
        var url = $"/player_api.php?username={Uri.EscapeDataString(_options.Username)}&password={Uri.EscapeDataString(_options.Password)}&action=get_series&category_id={Uri.EscapeDataString(categoryId)}";
        var response = await _httpClient.GetAsync(url);
        response.EnsureSuccessStatusCode();
    ...
    {
        var url = $"/player_api.php?username={Uri.EscapeDataString(_options.Username)}&password={Uri.EscapeDataString(_options.Password)}&action=get_series_info&series_id={seriesId}";
        var response = await _httpClient.GetAsync(url);
        response.EnsureSuccessStatusCode();
